...
<body>
	...
	<input type=button value="更新"
		onclick="location.href ='/ManageCard/update/'">
	<hr>
	...
	<div class="container">
		...
		<br>
		<br> <input type=text placeholder="カードIDを入力"> <input
			type=text placeholder="現ポイントを入力" size=20> <input type=button
			value="カード追加" onclick="tuika(this.form);return false"> <br>
		<br>
		<br> <a href="/seproject/list"><input type=button
			value="一覧画面に戻る"></a> <a href="/seproject/top"><input
