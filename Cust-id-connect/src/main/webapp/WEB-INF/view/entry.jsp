...
<body>
	...
	<form:form modelAttribute="customerData">
		<table>
			...
			<tr>
				<td>氏名</td>
				<td><form:input path="name" class="hoge" placeholder="ここに氏名を入力"
			...
			<tr><td>　</td></tr><tr>
				<td></td>
				<td><input type="submit" class="piyo"value="登録" /> <input type="reset" class="piyo" />
					<a href="/Cust-id-connect/list"><input type="button"
						value="一覧画面に戻る" class="piyo" /></a> <a href="/Cust-id-connect/top"><input
						type="button" value="トップ画面に戻る" class="piyo" /></a></td>
			</tr>
