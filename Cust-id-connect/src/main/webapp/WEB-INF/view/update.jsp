				...
				<table>
					...
					<tr>
						...
						<td><form:input path="name" class="hoge"
								placeholder="ここに氏名を入力" size="50" value="${iddata.name}" /> <!-- required="required"
					...
					<tr>
						...
						<td><form:input path="address" class="hoge"
								placeholder="ここに住所を入力" size="50" value="${iddata.address}" /> <%-- required="required"
					pattern="^[-a-zA-Z0-9ぁ-ゑァ-ヶ一-龠々][-a-zA-Z0-9ぁ-ゑんァ-ヶ一-龠々 　]{0,254}$"
					...
					<tr>
						...
						<td><form:input path="tel" class="hoge"
								placeholder="ここに電話番号を入力 " size="50" value="${iddata.tel}" /> <%-- required="required" pattern="\d{1,5}-\d{1,4}-\d{3,5}"
